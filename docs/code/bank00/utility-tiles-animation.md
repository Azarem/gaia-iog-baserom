...
```2394:2399:extracted/system/engine/actor_pool.asm
AnimFrameLookup {
    ASL 
    TAY 
...
```2375:2390:extracted/system/engine/actor_pool.asm
SetActorBody {
    LDA $0AD4
    ASL 
    CLC 
...
- [`../../cop/README.md`](../../cop/README.md) — Full COP operand reference
