...
- **Handler:** `WaitWhileOffscreen` @ `extracted/system/engine/cop_handlers_spatial.asm`
...
- **Handler:** `BranchIfOffCamera` @ `extracted/system/engine/cop_handlers_map.asm`
- **Parameters:** `&Code`
...
- **Handler:** `HaltIfMaxFrames` @ `cop_handlers_map.asm`
