...
_Ops: `[C0]`–`[CB]`, `[E1]`, `[E2]`_ · _Source: `extracted/system/engine/cop_handlers_flow.asm`_
...
- **Handler:** `SetInteractHandler` @ `extracted/system/engine/cop_handlers_flow.asm:31-40`
...
- **Handler:** `SetEntryHere` @ `cop_handlers_flow.asm:45-53`
- **Parameters:** (none)
- **Usage count:** 1295
...
- **Handler:** `SetEntryHereAndYield` @ `cop_handlers_flow.asm:58-67`
- **Parameters:** (none)
- **Usage count:** 502
...
- **Handler:** `JumpAfterDelay` @ `cop_handlers_flow.asm:72-89`
...
- **Handler:** `JumpNextFrame` @ `cop_handlers_flow.asm:94-108`
- **Parameters:** `@Code`
- **Usage count:** 61
...
- **Handler:** `RestoreSavedPtr` @ `cop_handlers_flow.asm:132-145`
...
- **Handler:** `SetSavedPtr` @ `cop_handlers_flow.asm:169-178`
- **Parameters:** `&Code`
- **Usage count:** 53
...
- **Aliases:** `JumpScript`
- **Handler:** `JumpFar` @ `cop_handlers_flow.asm:183-198`
- **Parameters:** `@Code`
- **Usage count:** 22
...
- **Aliases:** `CallScript`
- **Handler:** `CallNear` @ `cop_handlers_flow.asm:203-212`
- **Parameters:** `&Code`
- **Usage count:** 230
...
- **Handler:** `CallNearDeferred` @ `cop_handlers_flow.asm:217-228`
- **Parameters:** `&Code`
- **Usage count:** 8
...
- **Aliases:** `LoopInit`
- **Handler:** `LoopStart` @ `cop_handlers_flow.asm:233-259`
...
- **Aliases:** `LoopNext`
- **Handler:** `LoopEnd` @ `cop_handlers_flow.asm:264-293`
- **Parameters:** (none)
- **Usage count:** 284
...
- **Handler:** `ReturnWithSignal` @ `cop_handlers_flow.asm:150-164`
- **Parameters:** (none)
- **Usage count:** 4
...
- **Handler:** `SetEntryFar` @ `cop_handlers_flow.asm:113-127`
- **Parameters:** `@Code`
- **Usage count:** 1
