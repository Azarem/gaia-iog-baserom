...
_Ops: `[B2]`, `[B3]`, `[B4]`, `[B5]`, `[B6]`, `[B7]`, `[B8]`, `[B9]`, `[BA]`, `[BB]`_ · _Source: `extracted/system/engine/cop_handlers_lifecycle.asm`_
...
- **Handler:** `SetPriorityMax` @ `cop_handlers_lifecycle.asm:704-711`
- **Parameters:** (none)
- **Outcome:** Continue
- **Usage count:** 14
...
- **Handler:** `SetPriorityMin` @ `cop_handlers_lifecycle.asm:716-723`
- **Parameters:** (none)
- **Outcome:** Continue
- **Usage count:** 3
...
- **Handler:** `ClearPriorityMax` @ `cop_handlers_lifecycle.asm:728-735`
- **Parameters:** (none)
- **Outcome:** Continue
- **Usage count:** 11
...
- **Handler:** `ClearPriorityMin` @ `cop_handlers_lifecycle.asm:740-747`
- **Parameters:** (none)
- **Outcome:** Continue
- **Usage count:** 1
...
- **Handler:** `SetOamPriority` @ `cop_handlers_lifecycle.asm:752-764`
...
- **Handler:** `SetOamPalette` @ `cop_handlers_lifecycle.asm:769-781`
- **Parameters:** `Byte` 0–7
- **Outcome:** Continue
- **Usage count:** 88
...
- **Aliases:** `ToggleHFlip`
- **Handler:** `ToggleHMirror` @ `cop_handlers_lifecycle.asm:786-794`
- **Parameters:** (none)
- **Outcome:** Continue
- **Usage count:** 4
...
- **Aliases:** `ToggleVFlip`
- **Handler:** `ToggleVMirror` @ `cop_handlers_lifecycle.asm:799-807`
- **Parameters:** (none)
- **Outcome:** Continue
- **Usage count:** 10
...
- **Aliases:** `ClearHFlip`
- **Handler:** `ClearHMirror` @ `cop_handlers_lifecycle.asm:812-819`
- **Parameters:** (none)
- **Outcome:** Continue
- **Usage count:** 3
...
- **Aliases:** `SetHFlip`
- **Handler:** `SetHMirror` @ `cop_handlers_lifecycle.asm:824-831`
- **Parameters:** (none)
- **Outcome:** Continue
- **Usage count:** 23
