...
_Deep-audited ops: `[26]`, `[65]`, `[66]`, `[67]`_ · _Source: [`cop_handlers_player_query.asm`](../../../extracted/system/engine/cop_handlers_player_query.asm), [`cop_handlers_world_map.asm`](../../../extracted/system/engine/cop_handlers_world_map.asm)_
...
- **Handler:** `QueueMapChange` @ [`cop_handlers_player_query.asm`](../../../extracted/system/engine/cop_handlers_player_query.asm)
...
- **Handler:** `StageWorldMapMove` @ [`cop_handlers_world_map.asm`](../../../extracted/system/engine/cop_handlers_world_map.asm)
...
- **Handler:** `StageWorldMapChoice` @ [`cop_handlers_world_map.asm`](../../../extracted/system/engine/cop_handlers_world_map.asm)
...
- **Handler:** `StageWorldMapMoveIds` @ [`cop_handlers_world_map.asm`](../../../extracted/system/engine/cop_handlers_world_map.asm)
