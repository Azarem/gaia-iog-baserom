...
- **Handler:** `StageMoveX` @ [`cop_handlers_force_move.asm:541-552`](../../../extracted/system/engine/cop_handlers_force_move.asm)
...
- **Handler:** `StageMoveY` @ [`cop_handlers_force_move.asm:557-568`](../../../extracted/system/engine/cop_handlers_force_move.asm)
...
- **Handler:** `StageMoveXY` @ [`cop_handlers_force_move.asm:573-590`](../../../extracted/system/engine/cop_handlers_force_move.asm)
...
- **Aliases:** `SetForceSW`
- **Handler:** `ForceDirSW` @ [`cop_handlers_force_move.asm:595-613`](../../../extracted/system/engine/cop_handlers_force_move.asm)
...
- **Aliases:** `SetForceNE`
- **Handler:** `ForceDirNE` @ [`cop_handlers_force_move.asm:618-636`](../../../extracted/system/engine/cop_handlers_force_move.asm)
...
- **Handler:** `ForceDirBoth` @ [`cop_handlers_force_move.asm:641-659`](../../../extracted/system/engine/cop_handlers_force_move.asm)
- **Parameters:** `Byte` set/clear
- **Outcome:** Continue
- **Usage count:** 6
...
- **Handler:** `ApplyMoveToChild` @ [`cop_handlers_force_move.asm:664-683`](../../../extracted/system/engine/cop_handlers_force_move.asm)
- **Parameters:** `Byte` X index, `Byte` Y index
- **Outcome:** Continue
- **Usage count:** 16
...
- **Handler:** `ReloadMoveDurations` @ [`cop_handlers_force_move.asm:688-699`](../../../extracted/system/engine/cop_handlers_force_move.asm)
- **Parameters:** (none)
- **Outcome:** Continue
- **Usage count:** 25
