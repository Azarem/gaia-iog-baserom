...
_Deep-audited ops: `[25]`, `[46]`, `[47]`, `[BC]`_
...
- **Handler:** `SetTilePos` @ `extracted/system/engine/cop_handlers_spatial.asm`
...
- **Handler:** `CopyPosToPrev` @ `extracted/system/engine/cop_handlers_lifecycle.asm`
- **Parameters:** (none)
...
- **Handler:** `CopyPosToNext` → shared `loc_00964F` @ `cop_handlers_lifecycle.asm`
- **Parameters:** (none)
...
- **Handler:** `NudgePosition` @ `cop_handlers_lifecycle.asm`
