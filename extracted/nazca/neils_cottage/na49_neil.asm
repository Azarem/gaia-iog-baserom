...
na49_neil [
  ...
  code_05D89D:
    ...
    COP [WaitByte] ( #13 )
    COP [LoopNext]
    COP [PrintWideString] ( &widestring_05D984 )
    ...
    COP [AnimLoop]
    COP [PrintWideString] ( &widestring_05D9C1 )
    COP [SetFlagByte] ( #02 )
    COP [ExitIfFlagByte] ( #02, #00 )
    COP [PrintWideString] ( &widestring_05DA04 )
    COP [SetFlagByte] ( #03 )
    COP [ExitIfFlagByte] ( #03, #00 )
    COP [PrintWideString] ( &widestring_05DAC7 )
    LDA #$0000
    STA $0AA6
    COP [SetFlagByte] ( #05 )
    LDA #$CFF0
...
code_05D96F {
    ...
    CMP #$000F
    BEQ loc_05D97C
    COP [PrintWideString] ( &widestring_05DB1C )
    RTL 

  loc_05D97C:
    COP [PrintWideString] ( &widestring_05DB9C )
    COP [SetFlagByte] ( #06 )
    RTL 
}

widestring_05D984 `[PAU:1E][TPL:A][TPL:6]Neil: [N]It's open, come in. [FIN][TPL:0]Will: [N]Neil. It's me. [N]Will from South Cape.[END]`

widestring_05D9C1 `[TPL:A][TPL:6]Neil: [N]Oh! Will! [N]You've gotten strong! [FIN]Are all of these people[N]your friends?[END]`
...
widestring_05DAC7 `[TPL:A][TPL:6]Neil: [N]I've heard enough [N]about my socks. [FIN]Make yourself at home. [N]You're Will's friends. [N]Welcome. [END]`

widestring_05DB1C `[TPL:A][TPL:6]Neil: It's been about [N]two years since we [N]last met, hasn't it? [FIN]I've invented lots of[N]things since then.[FIN]The four inventions in[N]this room are my[N]best work. Have a look.[END]`
...
code_05DCFF {
    COP [PrintWideString] ( &widestring_05DD04 )
    RTL 
}

widestring_05DD04 `[TPL:A][TPL:6]Neil: Will, where are you [N]going in such a hurry? [N]Stay a while.[PAL:0][END]`