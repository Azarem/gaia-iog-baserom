...
code_0BEE2C {
    ...
    LDA #$00FF
    STA $abilityBitmask
    COP [PrintWideString] ( &widestring_0BF010 )
...
code_0BEE58 {
    COP [PrintWideString] ( &widestring_0BF05C )
...
code_0BEE6C {
    COP [PrintWideString] ( &widestring_0BF095 )
...
code_0BEE80 {
    COP [PrintWideString] ( &widestring_0BF0C3 )
...
code_0BEE94 {
    COP [PrintWideString] ( &widestring_0BF0EC )
...
code_0BEEA8 {
    COP [PrintWideString] ( &widestring_0BF10D )
...
code_0BEEBC {
    COP [PrintWideString] ( &widestring_0BF135 )
...
code_0BEED0 {
    COP [PrintWideString] ( &widestring_0BF15A )
    RTL 
}

code_0BEED5 {
    COP [PrintWideString] ( &widestring_0BF164 )
...
widestring_0BF010 `[DEF]Hello! I am Debug-man![N]Where you go?[FIN] Others[N] Great Wall[N] LAST GAIA LOOK[N] EDOWA-DO`

widestring_0BF05C `[CLR] Others[N] Itorie[N] HOME OF MOON TRIBE[N] Underground castle`

widestring_0BF095 `[CLR] Others[N] City of Euro[N] Native's Village[N] Desert Village Dao`

widestring_0BF0C3 `[CLR] Others[N] INCA[N] HANANOMIYAKO[N] DAIYAMONDO`

widestring_0BF0EC `[CLR] Others[N] Sky Garden[N] Palace[N] Mu`

widestring_0BF10D `[CLR] Others[N] Angel Village[N] Native's Village[N] Dao`
