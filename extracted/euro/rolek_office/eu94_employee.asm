...
code_07CF13 {
    COP [PrintWideString] ( &widestring_07CF75 )
    COP [SetEntryContinue]
    RTL 
}

code_07CF1A {
    COP [PrintWideString] ( &widestring_07CF1F )
    RTL 
}

widestring_07CF1F `[TPL:A][TPL:4]Company employee:[N]What?!![N]A child...[FIN]The old guys are talking[N]about work. Go[N]over there![END]`
