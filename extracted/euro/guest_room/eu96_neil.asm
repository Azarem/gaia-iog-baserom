...
eu96_neil [
  ...
  code_07DB28:
    ...
    TSB $joypadMaskStd
    COP [WaitByte] ( #1D )
    COP [PrintWideString] ( &widestring_07DBE9 )
...
code_07DB5F {
    ...
    COP [WaitByte] ( #1D )
    COP [PrintWideString] ( &widestring_07DC37 )
    COP [WaitByte] ( #1D )
    ...
    COP [AnimOnce]
    COP [SolidHighHere]
    COP [PrintWideString] ( &widestring_07DC63 )
    COP [WaitByte] ( #27 )
    COP [StartMusic] ( #1B )
    COP [WaitByte] ( #3B )
    COP [PrintWideString] ( &widestring_07DD70 )
    COP [SetFlagByte] ( #01 )
    ...
    COP [AnimLoop]
    COP [PrintWideString] ( &widestring_07DDBF )
    COP [SpawnAfterRelFlags] ( @code_07DECB, #$0000, #$0020, #$1800 )
    COP [ExitIfFlagByte] ( #02, #01 )
    COP [StartMusic] ( #02 )
    COP [WaitByte] ( #77 )
    COP [PrintWideString] ( &widestring_07DDD2 )
    COP [SetFlagByte] ( #AB )
...
code_07DBE4 {
    COP [PrintWideString] ( &widestring_07DEAD )
    RTL 
}

widestring_07DBE9 `[TPL:A][TPL:6]Neil: [N]Well, make yourself at [N]home.. [FIN]I want to talk to my[N]parents. It's been[N]three years.[PAL:0][END]`

widestring_07DC37 `[TPL:A][TPL:0]The next morning.[N]Disappointment awaits...[END]`
...
widestring_07DD70 `[TPL:B][TPL:6][DLY:2]Neil: Kara, someone's [N]come asking about you. [N]Something about being [N]an old friend. [FIN][TPL:1][DLY:0]Kara: [N]What!!!? [END]`

widestring_07DDBF `[TPL:A][TPL:6]Neil: [N]Hey! Come on in! [END]`
...
widestring_07DEAD `[TPL:A][TPL:6]Neil: [N]Take care, everyone.[PAL:0][END]`
...
code_07DEF4 {
    COP [PrintWideString] ( &widestring_07DEF9 )
    RTL 
}

widestring_07DEF9 `[TPL:8]Oink oink[PAL:0][END]`