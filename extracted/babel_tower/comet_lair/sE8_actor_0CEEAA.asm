...
sE8_actor_0CEEAA [
  ...
  loc_0CEEF1:
    ...
    COP [SetEntryExit]
    LDY #$0F00
    LDA #$&sE8_thinker_0CEB74.code_0CEBA1
    STA $0000, Y
    COP [StartMusic] ( #10 )
  ...
  loc_0CEF11:
    ...
    LDA #$2000
    TRB $10
    COP [SpawnLastRel] ( @code_0CF550, #00, #00, #$0301 )
    STY $24
    LDA #$0064
    STA $26
    COP [SetEntryContinue]
...
code_0CEF3C {
    LDA #$2000
    TSB $10
    COP [SpawnLastRel] ( @code_0CEF6D, #00, #00, #$2000 )
    COP [LoopInit] ( #10 )
    LDY $24
    BEQ loc_0CEF5A
    LDA $0010, Y
...
code_0CEF88 {
  ...
  loc_0CEFA6:
    ...
    COP [WaitByte] ( #3B )
    LDY #$0F00
    LDA #$&sE8_thinker_0CEB74.code_0CEB76
    STA $0000, Y
  ...
  loc_0CF016:
    ...
    COP [WaitByte] ( #63 )
    LDY #$0F00
    LDA #$&sE8_thinker_0CEB74.code_0CEBF7
    STA $0000, Y
    COP [WaitByte] ( #63 )
    LDA #$0080
    ...
    COP [ApplyBgChange]
    COP [SpawnMarkedAfter] ( @code_0CF4E3, #$0301 )
    TYA 
    STA $orbitAngle, X
    COP [SpawnMarkedAfter] ( @code_0CF3FC, #$2200 )
    COP [SpawnMarkedAfter] ( @code_0CF403, #$2200 )
    LDA #$0080
    STA $14
    LDA #$0150
    STA $16
...
code_0CF0C0 {
    ...
    COP [SetFlagByte] ( #02 )
    COP [SpawnLastRel] ( @code_0CED45, #00, #00, #$2000 )
    COP [PlaySoundCh1] ( #20 )
    COP [SpawnLastRel] ( @code_0CF266, #00, #00, #$2200 )

  code_0CF10B:
    COP [StageSpriteFrame] ( #1A )
    COP [AnimOnce]
    COP [BranchIfFlagByte] ( #02, #01, &code_0CF10B )
    LDA #$00FF
    STA $WH0
...
code_0CF13B {
    COP [SpawnLastRel] ( @code_0CF2F2, #00, #00, #$0301 )
    COP [SpawnLastRel] ( @code_0CF31F, #00, #00, #$0301 )
    COP [WaitWord] ( #$012B )
    JMP $&code_0CF08A
}
...
code_0CF154 {
    ...
    COP [SpawnLastRel] ( @code_0CF1F0, #00, #00, #$0300 )
    COP [SpawnLastRel] ( @code_0CF291, #00, #00, #$2800 )
    COP [StageSpriteFrame] ( #19 )
    COP [AnimOnce]
    COP [StageSpriteFrame] ( #1E )
    COP [AnimOnce]
    LDY #$0F00
    LDA #$&sE8_thinker_0CEB74.code_0CEC35
    STA $0000, Y
    COP [SpawnThinker] ( @oneshot_palette_flash_18.code_00B7CE )
    COP [WaitWord] ( #$012B )
    LDA #$0404
...
code_0CF201 {
    ...
    COP [LoopInit] ( #0C )
    COP [SpawnLastRel] ( @code_0CF22F, #00, #00, #$0302 )
    COP [WaitByte] ( #01 )
    COP [SpawnLastRel] ( @code_0CF23C, #00, #00, #$0302 )
    COP [WaitByte] ( #03 )
    COP [LoopNext]
    COP [Die]
}
...
code_0CF403 {
  ...
  loc_0CF40D:
    ...
    STA $08
    COP [SetEntryExit]
    COP [BranchIfFlagByte] ( #04, #01, &code_0CF4E1 )
    COP [SpawnMarkedAfter] ( @code_0CF429, #$0200 )
    BRA loc_0CF40D
}
...
code_0CF429 {
  ...
  loc_0CF47E:
    COP [SetEntryContinue]
    COP [BranchIfFlagByte] ( #04, #01, &code_0CF4DC )
    COP [RngByte]
    LDY $playerActor
    AND #$007F
    SEC 
...
code_0CF4E3 {
    ...
    LDA #$01AA
    STA $16
    COP [SpawnMarkedAfterRel] ( @code_0CF549, #FC, #FC, #$0301 )
    COP [SpawnMarkedAfterRel] ( @code_0CF543, #04, #00, #$0301 )
...
code_0CF570 {
  ...
  loc_0CF578:
    ...
    COP [AnimOnce]
    COP [BranchIfFlagByte] ( #03, #01, &code_0CF5AD )
    LDA $16
    BPL loc_0CF578
    BPL loc_0CF58E
    EOR #$FFFF
