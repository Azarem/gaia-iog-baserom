...
code_0AB12B {
    ...
    CMP #$00E9
    BNE loc_0AB138
    COP [JumpNextFrame] ( @code_0AB119 )

  loc_0AB138:
    LDA #$0300
    TSB $10
    COP [CallNear] ( &code_0AB3CA )
    LDA #$0300
    TRB $10
    BRA code_0AB114
}
...
code_0AB22A {
  ...
  loc_0AB256:
    ...
    COP [AnimOnce]
    COP [SpawnAfterOffsetMarked] ( @code_0AB39E, #E8, #EB, #$2200 )
    COP [WaitByte] ( #05 )
    COP [RestoreSavedPtr]
}
...
code_0AB26E {
  ...
  loc_0AB29A:
    ...
    COP [AnimOnce]
    COP [SpawnAfterOffsetMarked] ( @code_0AB399, #18, #EB, #$2200 )
    COP [WaitByte] ( #05 )
    COP [RestoreSavedPtr]
}
...
code_0AB2BC {
  ...
  loc_0AB2E8:
    ...
    COP [AnimOnce]
    COP [SpawnAfterOffsetMarked] ( @code_0AB344, #00, #F8, #$2200 )
    COP [WaitByte] ( #05 )
    COP [RestoreSavedPtr]
}
...
code_0AB300 {
  ...
  loc_0AB32C:
    ...
    COP [AnimOnce]
    COP [SpawnAfterOffsetMarked] ( @code_0AB36D, #00, #07, #$2202 )
    COP [WaitByte] ( #05 )
    COP [RestoreSavedPtr]
}
