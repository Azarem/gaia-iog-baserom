...
code_0AC700 {
  ...
  loc_0AC72A:
    ...
    COP [SpawnAfterOffsetFlags] ( @code_0AC7B2, #$0000, #$0000, #$0302 )
    COP [SetEntryHereAndYield]
    COP [SpawnAfterOffsetFlags] ( @code_0AC7C6, #$0000, #$0000, #$0302 )
    COP [SetEntryHereAndYield]
    COP [SpawnAfterOffsetFlags] ( @code_0AC7D0, #$0000, #$0000, #$0302 )
    COP [SetEntryHereAndYield]
    COP [SpawnAfterOffsetFlags] ( @code_0AC7DA, #$0000, #$0000, #$0302 )
    COP [SetEntryHereAndYield]
    COP [SpawnAfterOffsetFlags] ( @code_0AC7E4, #$0000, #$0000, #$0302 )
    COP [SetEntryHereAndYield]
    COP [SpawnAfterOffsetFlags] ( @code_0AC7EE, #$0000, #$0000, #$0302 )
    COP [SetEntryHereAndYield]
    COP [SpawnAfterOffsetFlags] ( @code_0AC7F8, #$0000, #$0000, #$0302 )
    COP [SetEntryHereAndYield]
...
code_0AC7FD {
  ...
  loc_0AC808:
    COP [PlaySoundCh1] ( #06 )
    COP [SetEntryHereAndYield]
    COP [NudgePosition] ( #04, #14 )
    COP [JumpFar] ( @EnemyDeathFlash )
}