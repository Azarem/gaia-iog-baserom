...
code_09C6E8 {
    ...
    COP [SetFlagByte] ( #01 )
    COP [SpawnAfterAbsFlags] ( @ec_actor_09C2D0.code_09C2DB, #$01A8, #$0130, #$2300 )
    BRA code_09C6DF
}
...
code_09C6FE {
    ...
    COP [SetFlagByte] ( #02 )
    COP [SpawnAfterAbsFlags] ( @ec_actor_09C2D0.code_09C2DB, #$01C8, #$01C0, #$2300 )
    BRA code_09C6DF
}
...
code_09C714 {
    ...
    COP [SetFlagByte] ( #03 )
    COP [SpawnAfterAbsFlags] ( @ec_actor_09C2D0.code_09C2DB, #$00E8, #$0260, #$2300 )
    BRA code_09C6DF
}
...
code_09C72A {
    ...
    COP [SetFlagByte] ( #04 )
    COP [SpawnAfterAbsFlags] ( @ec_actor_09C2D0.code_09C2E4, #$0088, #$0220, #$2300 )
    COP [WaitByte] ( #0E )
    COP [SpawnAfterAbsFlags] ( @ec_actor_09C2D0.code_09C2E4, #$0088, #$0200, #$2300 )
    BRA code_09C6DF
}
...
code_09C74E {
    ...
    COP [SetFlagByte] ( #05 )
    COP [SpawnAfterAbsFlags] ( @ec_actor_09C2D0.code_09C2E4, #$0088, #$01C0, #$2300 )
    COP [WaitByte] ( #0E )
    COP [SpawnAfterAbsFlags] ( @ec_actor_09C2D0.code_09C2E4, #$0088, #$01A0, #$2300 )
    JMP $&code_09C6DF
}
...
code_09C773 {
    ...
    COP [SetFlagByte] ( #06 )
    COP [SpawnAfterAbsFlags] ( @ec_actor_09C2D0.code_09C2E4, #$0128, #$0160, #$2300 )
    COP [WaitByte] ( #0E )
    COP [SpawnAfterAbsFlags] ( @ec_actor_09C2D0.code_09C2E4, #$0128, #$0140, #$2300 )
    JMP $&code_09C6DF
}