...
code_04E954 {
    COP [PrintDialogString] ( &dialogstring_04EA45 )
}
...
code_04E9A0 {
    COP [PrintDialogString] ( &dialogstring_04EC46 )
...
code_04E9B0 {
    COP [PrintDialogString] ( &dialogstring_04EC76 )
    COP [SetFlagByte] ( #0F )
    RTL 
}

code_04E9B8 {
    COP [PrintDialogString] ( &dialogstring_04ECAB )
}

code_04E9BC {
    COP [PrintDialogString] ( &dialogstring_04ECCB )
...
code_04E9CC {
    COP [PrintDialogString] ( &dialogstring_04ECEC )
    COP [SetFlagByte] ( #0E )
    RTL 
}

code_04E9D4 {
    COP [PrintDialogString] ( &dialogstring_04ED19 )
    COP [SetFlagByte] ( #47 )
    RTL 
}

code_04E9DC {
    COP [PrintDialogString] ( &dialogstring_04EF6F )
    RTL 
}

code_04E9E1 {
    COP [PrintDialogString] ( &dialogstring_04EDF4 )
...
code_04E9F1 {
    COP [PrintDialogString] ( &dialogstring_04EF1C )
    BRA loc_04E9E5
}

code_04E9F7 {
    COP [PrintDialogString] ( &dialogstring_04EF23 )
    COP [SetFlagByte] ( #44 )
    RTL 
}

dialogstring_04E9FF `[DLG:3,11][SIZ:D,2]Will hears a quiet [N]voice behind him... [FIN][TPL:D][TPL:4]Strange Voice: [N]You've come, Will...[PAL:0][END]`

dialogstring_04EA45 `[TPL:E][TPL:4]Elder: I'm here. [N]In the flowers. [N]I've lived too long.[PAL:0][END]`

dialogstring_04EA77 `[DEF][TPL:4]Elder: I can't live [N]without the protection [N]of the Flower Spirit. [FIN]You really look like[N]your father.[FIN]It seems like only[N]yesterday that he came[N]to this village.[FIN][TPL:0]Will: [N]My father... [FIN][TPL:4]Elder: Your mother, Shira,[N]was the only daughter[N]of your grandparents,[N]Bill and Lola.[FIN]She was very beautiful.[FIN]Your father fell in love[N]with her and took her[N]from the village.[FIN]All of the Itory tribe[N]have a strange power, [N]but Shira's was [N]especially strong. [FIN]She made a barrier to[N]hide the town, but[N]your father came[N]through it easily.[FIN]Come to think of it, he[N]was unusual, too...[FIN]`

dialogstring_04EC46 `[DEF][TPL:4]Were you summoned  [N]by your father? [N][PAL:0] Yes[N] No`

dialogstring_04EC76 `[CLR][TPL:4]Elder: What? If you[N]weren't....That's a[N]bad sign....[PAL:0][END]`

dialogstring_04ECAB `[CLR][TPL:4]Elder: That fulfills[N]Lola's prophesy.[FIN]`

dialogstring_04ECCB `[DEF][TPL:4]Do you plan to go?[N][PAL:0] Yes[N] No`

dialogstring_04ECEC `[DEF][CLR][TPL:4]Elder: A disobedient [N]son, unlike your father.[PAL:0][END]`

dialogstring_04ED19 `[DEF][CLR][TPL:4]Elder: Good. I will [N]entrust you with the [N]Incan Statue handed down [N]to the village. [FIN]The statues are the key [N]to the Incan riddle-- [N]untouched by human hands [N]for hundreds of years. [FIN]One statue is enshrined [N]in the cave below. [N]Use all your skill to [N]find it.[PAL:0][END]`
