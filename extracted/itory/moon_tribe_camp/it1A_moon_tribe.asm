...
it1A_moon_tribe [
  ...
  code_09D0F8:
    LDA #$0200
    TSB $12
    COP [BranchOnFlagByte] ( #2A, #01, &code_09D137 )
    PHX 
    LDX #$00E0
    LDA #$0000
...
code_09D137 {
    ...
    COP [MarkSolidHere]
    COP [SetInteractHandler] ( &code_09D1D3 )
    COP [SetEntryHere]
...
it1A_moon_tribe2 [
  ...
  code_09D156:
    COP [WaitOnFlagByte] ( #2A, #01 )
    LDA #$2000
    TRB $10
    COP [MarkSolidHere]
    LDA #$0200
    TSB $12
    COP [SetInteractHandler] ( &code_09D1D8 )
    COP [SetEntryHere]
    COP [StageSpriteMoveY] ( #27, #3B )
    COP [AnimOnce]
    RTL 
...
it1A_moon_tribe3 [
  ...
  code_09D176:
    ...
    LDA #$0200
    TSB $12
    COP [SetInteractHandler] ( &code_09D1DD )
    COP [SetEntryHere]
    COP [StageSpriteMoveY] ( #27, #3B )
    COP [AnimOnce]
    RTL 
...
it1A_moon_tribe4 [
  ...
  code_09D196:
    ...
    LDA #$0200
    TSB $12
    COP [SetInteractHandler] ( &code_09D1F2 )
    COP [SetEntryHere]
    COP [StageSpriteMoveY] ( #27, #3B )
    COP [AnimOnce]
    RTL 
...
it1A_moon_tribe5 [
  ...
  code_09D1B6:
    ...
    LDA #$0200
    TSB $12
    COP [SetInteractHandler] ( &code_09D1F7 )
    COP [SetEntryHere]
    COP [StageSpriteMoveY] ( #27, #3B )
    COP [AnimOnce]
    RTL 
