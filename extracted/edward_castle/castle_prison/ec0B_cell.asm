...
ec0B_cell [
  ...
  code_04D205:
    ...
    TSB $joypadMaskStd
    COP [WaitByte] ( #1D )
    COP [PrintWideString] ( &widestring_04D42F )
    LDA #$CFF0
    TRB $joypadMaskStd
...
code_04D251 {
    COP [PrintWideString] ( &widestring_04D60A )
...
code_04D275 {
    LDA #$CFF0
    TSB $joypadMaskStd
    COP [PrintWideString] ( &widestring_04D679 )
    COP [WaitByte] ( #1D )
    COP [SpawnThinker] ( @oneshot_palette_flash_1B.code_00B7E2 )
    COP [WaitByte] ( #BF )
    COP [PrintWideString] ( &widestring_04D732 )
    COP [SpawnThinker] ( @oneshot_palette_flash_1C.code_00B7EC )
    COP [WaitByte] ( #BF )
    LDA #$CFF0
    TRB $joypadMaskStd
    COP [PrintWideString] ( &widestring_04D78A )
...
code_04D2AC {
    COP [PrintWideString] ( &widestring_04D87D )
  ...
  loc_04D2C3:
    COP [WaitByte] ( #1D )
    COP [PrintWideString] ( &widestring_04D8D2 )
    LDA #$1000
    TRB $10
...
code_04D2D6 {
    ...
    LDA #$2000
    TRB $10
    COP [PrintWideString] ( &widestring_04D4A5 )
...
code_04D329 {
    COP [PrintWideString] ( &widestring_04D4B1 )
    COP [GiveItem] ( #02, &code_04D342 )
    COP [SetFlagByte] ( #23 )
    LDA #$0080
    TSB $displayModeFlags
    COP [MusicAndText] ( #17, @widestring_04D5F4 )
    RTL 
}
...
code_04D36F {
    COP [PrintWideString] ( &widestring_04D37A )
    COP [SetFlagByte] ( #01 )
    COP [ClearLowHere]
    COP [Die]
}

widestring_04D37A `[DLG:3,11][SIZ:D,3]Will tastes some of[N]the bread.[FIN]The bread is hard.[N]It's the worst thing[N]he's ever tasted.[FIN]For some reason, he[N]really misses Grandma[N]Lola's creative cuisine...[END]`
...
widestring_04D42F `[DLG:3,11][SIZ:D,3][TPL:0]Will: [N]I wonder why I have[N]to suffer so...[FIN]I wonder what will[N]become of me now.[FIN]Anyway, I have to[N]think of a way[N]to get out of here.[PAL:0][END]`

widestring_04D4A5 `[TPL:C]Oink oink[PAU:28][CLD]`

widestring_04D4B1 `[DLG:3,11][SIZ:D,4][TPL:0]Will: [N]I wonder if this [N]is Kara's pig...[FIN]What luck! There's a[N]letter and a key tied[N]to its tail...[FIN][TPL:F][PAL:0]The letter read...[FIN][TPL:1] Sorry to hear[N] that you're in prison.[FIN] It's terrible what my[N] father's done, but hear[N] what I have to say.[FIN] I too am a prisoner[N] --in a prison of silk[N] and gold. [FIN] But tonight I [N] will leave the castle[N] forever. [FIN] You also will [N] be free. [N]                  Kara[PAL:0][FIN]`

widestring_04D5F4 `[CLR][SFX:0][DLY:9]You have the key![PAU:FF][END]`

widestring_04D60A `[DLG:3,12][SIZ:D,3]A soldier's whisper[N]comes from a hole[N]in the ceiling.[FIN][DLG:3,12][SIZ:D,3]It's today's ration of[N]bread.[N]Even moss drinks water.[END]`

widestring_04D679 `[DLG:3,11][SIZ:D,4][TPL:0]Time passes slowly, but[N]the long day is ending.[FIN]It pains me to think of[N]the prisoners' feelings,[N]not knowing what they[N]should do....[FIN]While I was trying to[N]think of a way out,[N]I drifted off to sleep.[PAL:0][END]`

widestring_04D732 `[PAU:78][DLG:3,11][SIZ:D,3][DLY:0]A familiar voice[N]speaks from the flute.[FIN][TPL:E][TPL:4]Flute: [N]Will....[FIN]Flute:[N]This is your father.[END]`

widestring_04D78A `[PAU:3C][TPL:E][TPL:0][DLY:0]Will: [N]Father...? [FIN][TPL:4]Flute: You were[N]a cute child, but now[N]you've grown up.[FIN]Isn't Grandma Lola's[N]pie delicious?[FIN][TPL:0]Will: [N]Uh, sure, Dad![N]Where are you?![FIN][TPL:4]Flute:[N]I can't tell you now...[FIN][TPL:F][TPL:4]I have something to ask[N]of you. Listen...[N][PAL:0] Yes, if it's your wish![N] No! You deserted me!`

widestring_04D87D `[CLD][TPL:F][TPL:4][CLR][DLY:0]Flute:[N]I want you to[N]save me....[FIN]I, too, was once[N]held in this cell.[N]Look at the[N]left-hand wall.[END]`

widestring_04D8D2 `[DEF][TPL:0]Will: [N]...This? [FIN][TPL:4]Flute: Have you[N]heard anything[N]from Grandpa Bill?[FIN][TPL:0]Will: [N]Grandpa?[N]He was an architect...[FIN][TPL:4]Flute:[N]Your Grandpa knows the [N]secret of that stone.[FIN][TPL:0]Will: [N]Secret...?[FIN][TPL:4]Flute: Starting now,[N]you will encounter[N]a terrible thing.[FIN][TPL:0]Will: [N]Do I have to...?[FIN][TPL:4]Flute: Pick up the[N]stone your enemy left.[FIN]The power of the[N]Crystal is contained[N]there.[FIN]That power will prove[N]to be your ally....[FIN]You must make a[N]pilgrimage to the ruins[N]of the world to find [N]the Mystic Statues.[FIN]The closer you get to [N]the Crystal, [N]the stronger the evil[N]power will be...[FIN]Will... No time...[N]Quickly... First[N]to the Incan ruins...[FIN][PAL:0][SFX:10]The flute's voice fades[N]and disappears.[END]`
