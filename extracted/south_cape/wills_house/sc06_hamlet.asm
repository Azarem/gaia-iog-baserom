...
sc06_hamlet [
  ...
  code_04A1DA:
    COP [BranchOnFlagByte] ( #1B, #01, &code_04A2EB )
    COP [BranchOnFlagByte] ( #3D, #01, &code_04A2ED )
    COP [BranchOnFlagByte] ( #16, #00, &code_04A2EB )
    COP [SetInteractHandler] ( &code_04A30C )
    LDA #$CFF0
    TSB $joypadMaskStd
...
code_04A238 {
  ...
  code_04A288:
    COP [StageSpriteFrame] ( #25 )
    COP [AnimOnce]
    COP [BranchOnFlagByte] ( #02, #00, &code_04A288 )
    COP [StageSpriteMoveY] ( #27, #12 )
    COP [AnimOnce]
  ...
  code_04A2B5:
    ...
    COP [AnimOnce]
    COP [BranchOnFlagByte] ( #04, #00, &code_04A2B5 )
    COP [ClearSolidHere]
  ...
  code_04A2C6:
    COP [StageSpriteFrame] ( #28 )
    COP [AnimOnce]
    COP [BranchOnFlagByte] ( #09, #00, &code_04A2C6 )
    LDA #$0800
    TSB $10
