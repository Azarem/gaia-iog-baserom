...
sc08_erik [
  ...
  code_048D98:
    ...
    COP [SetFlagByte] ( #01 )
    COP [WaitByte] ( #1D )
    COP [PrintDialogString] ( &dialogstring_048E00 )
...
dialogstring_048DD1 `[TPL:B][TPL:5]Seth:[N]I'll see you guys[N]at the usual place![PAL:0][END]`

dialogstring_048E00 `[TPL:B][TPL:3]Erik:[N]I have to go home[N]first. I'll see you guys[N]there later.[FIN]If you don't hurry home, [N]your mother will think [N]that you were kept after [N]school....Heh heh heh.[PAL:0][END]`