...
wa79_lance [
  ...
  code_07AC7F:
    ...
    STA $0016, Y
    COP [WaitByte] ( #1D )
    COP [PrintWideString] ( &widestring_07AD31 )
    COP [SetFlagByte] ( #01 )
    COP [ExitIfFlagByte] ( #03, #01 )
    COP [WaitByte] ( #27 )
    COP [PrintWideString] ( &widestring_07AD63 )
...
code_07AD02 {
    COP [PrintWideString] ( &widestring_07ADA9 )
    RTL 
}

code_07AD07 {
    COP [BranchIfFlagByte] ( #A5, #01, &code_07AD15 )
    COP [PrintWideString] ( &widestring_07ADEA )
    COP [SetFlagByte] ( #01 )
    RTL 
}
...
code_07AD15 {
    ...
    COP [PrintWideString] ( &widestring_07AEDE )
...
code_07AD2C {
    COP [PrintWideString] ( &widestring_07AFA7 )
    RTL 
}

widestring_07AD31 `[TPL:A][TPL:4]Lance: Let's have Lilly's [N]birthday party while [N]we're all together. [END]`

widestring_07AD63 `[TPL:A][TPL:4]Lance: Ah, Lilly. [N]Can I talk to you [N]for a minute? [FIN]I'll wait outside.[END]`

widestring_07ADA9 `[TPL:A][TPL:4]Lance: I made my father [N]very happy before. [FIN]I think he will slowly[N]recover.[PAL:0][END]`
...
widestring_07AFA7 `[TPL:B][TPL:4]I hope you get to[N]see your father soon.[PAL:0][END]`