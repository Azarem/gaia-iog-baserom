...
wa79_kara [
  ...
  code_07A53A:
    ...
    COP [AnimLoop]
    COP [PrintWideString] ( &widestring_07A6AF )
    COP [SetFlagByte] ( #03 )
...
code_07A5CB {
    ...
    TSB $joypadMaskStd
    COP [WaitByte] ( #1D )
    COP [PrintWideString] ( &widestring_07A79C )
    LDA #$CFF0
    TRB $joypadMaskStd
}
...
code_07A5FF {
    COP [PrintWideString] ( &widestring_07A613 )
    RTL 
}

code_07A604 {
    COP [PrintWideString] ( &widestring_07A7E2 )
    RTL 
}

code_07A609 {
    COP [PrintWideString] ( &widestring_07A811 )
    RTL 
}

code_07A60E {
    COP [PrintWideString] ( &widestring_07A833 )
    RTL 
}

widestring_07A613 `[TPL:B][TPL:1][SFX:1B]Kara: Watermia is very [N]pretty, but I've heard [N]a terrible rumor. [FIN]They play games with[N]human lives...[FIN]Freejia was the same [N]way, but beautiful. [N]Things always have [N]another side to them...[PAL:0][END]`
...
widestring_07A79C `[TPL:A][TPL:0]Will:[N]So in the morning...[FIN]When I awoke, Lance [N]had disappeared...[PAL:0][END]`

widestring_07A7E2 `[TPL:A][TPL:1]Kara: [N]What happened to Lance [N]and Lilly? I'm worried.[PAL:0][END]`

widestring_07A811 `[TPL:A][TPL:1]Kara: [N]A Kruk is an odd animal.[PAL:0][END]`

widestring_07A833 `[TPL:B][TPL:1]Kara: [N]Neil's family runs [N]a trading company in[N]Euro.[PAL:0][END]`
