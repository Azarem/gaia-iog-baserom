...
gs2D_lily [
  ...
  code_058CA5:
    ...
    TRB $10
    COP [WaitByte] ( #1D )
    COP [PrintWideString] ( &widestring_058DBB )
    COP [WaitByte] ( #3B )
    LDY $playerActor
...
code_058CFF {
    ...
    COP [PrintWideString] ( &widestring_058E4A )
    COP [StartMusic] ( #1B )
    COP [WaitByte] ( #3B )
    ...
    COP [WaitByte] ( #17 )
    COP [LoopNext]
    COP [PrintWideString] ( &widestring_058F44 )
    COP [StartMusic] ( #06 )
    COP [WriteApuIo1] ( #0A )
    COP [WaitByte] ( #77 )
    LDA #$0001
...
code_058DB1 {
    COP [PrintWideString] ( &widestring_058DDA )
    RTL 
}

code_058DB6 {
    COP [PrintWideString] ( &widestring_058F53 )
    RTL 
}

widestring_058DBB `[TPL:A][TPL:2]Lilly: [N]Will! [FIN]Will! Wake up![PAL:0][END]`

widestring_058DDA `[TPL:A][TPL:2]Lilly: You're back so[N]late, the Elder must[N]have read your fortune.[FIN]He said that you were [N]floating alone on the [N]sea. I was so surprised.[PAL:0][END]`
...
widestring_058F44 `[TPL:9][TPL:1]Kara: [N]What?[PAL:0][END]`

widestring_058F53 `[TPL:B][TPL:2]Lilly: [N]Maybe it belongs to[N]Riverson! [FIN]In this part of the [N]ocean, there are fish [N]that are as dangerous [N]as, well, sharks!![PAL:0][END]`