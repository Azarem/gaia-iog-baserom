...
code_06AF44 {
    ...
    COP [AnimOnce]
    COP [PrintWideString] ( &widestring_06B0BC )
    COP [SetFlagByte] ( #04 )
    COP [ClearLowHere]
...
code_06AF83 {
    ...
    COP [AnimLoop]
    COP [PrintWideString] ( &widestring_06B10B )
    COP [CallScript] ( &code_06B00C )
    COP [WaitByte] ( #3B )
    COP [StartMusic] ( #06 )
    COP [WaitByte] ( #B3 )
    COP [PrintWideString] ( &widestring_06B13C )
    COP [WaitByte] ( #59 )
    COP [CallScript] ( &code_06B03C )
    COP [FadeThenStartMusic] ( #1B )
    COP [WaitByte] ( #B3 )
    COP [PrintWideString] ( &widestring_06B195 )
    COP [WaitByte] ( #3B )
    COP [CallScript] ( &code_06B03C )
    COP [PrintWideString] ( &widestring_06B250 )
    COP [WaitByte] ( #3B )
    COP [PrintWideString] ( &widestring_06B3EC )
...
code_06B064 {
    COP [PrintWideString] ( &widestring_06B069 )
    RTL 
}

widestring_06B069 `[TPL:A][TPL:1]Kara: [N]I want a steak! [N]And a salad! [FIN]My skin has gone dry [N]from eating [N]weird food...[PAL:0][END]`

widestring_06B0BC `[TPL:A][TPL:1]Kara: Oh, no! [N]Will found more [N]mushrooms... [FIN][TPL:2]Lilly: It's better[N]than starving.[N]Well, let's eat.[PAL:0][END]`

widestring_06B10B `[TPL:A][TPL:1]Kara: Wait. [N]I hear it again!! [N]What is that sound...? [PAL:0][END]`

widestring_06B13C `[TPL:A][TPL:3]Erik: [N]Maybe it's Riverson...? [FIN][TPL:1][DLY:0]Kara: [N]Oh, no! We've [N]got to run!! [FIN][TPL:2]Lilly:[N]Run?[N]Run where?![PAL:0][END]`

widestring_06B195 `[TPL:A][TPL:6]Neil: [N]Quiet, everyone! [N]This vibrating sound... [FIN]It's Morse Code...[FIN]It's a signal ships use[N]to talk to each other.[FIN]The length of the[N]sound indicates letters.[FIN]Let's see if I can[N]decode it...Wait...[PAL:0][END]`

widestring_06B250 `[TPL:A][TPL:5][DLY:5]This is Seth... [FIN][TPL:4][DLY:0]Lance: [N]Seth?!! [FIN][TPL:2][DLY:0]Lilly:[N]Shh. Quiet![N][PAU:3C][DLY:0]Neil continues. [FIN][TPL:5][DLY:5]I was swallowed by[N]Riverson...[FIN]When I came to, the form[N]of my body had changed[N]to Riverson's.[FIN]This Riverson is a[N]creature who lives in[N]the ocean.[FIN]I don't know[N]if it's human or not.[FIN]He said that evolution[N]is being affected[N]by the light of a comet.[FIN]I wanted to continue[N]the journey with you,[N]but not in this body.[FIN]You must figure [N]out this riddle of the [N]comet and the ruins...[PAL:0][END]`
