...
code_06D171 {
    ...
    COP [AnimOnce]
    COP [WaitByte] ( #3B )
    COP [PrintWideString] ( &widestring_06D339 )
    LDA #$0003
    JSL $@InitPlayerScriptVariant
    COP [SetEntryExit]
    COP [PrintWideString] ( &widestring_06D364 )
    COP [StageSpriteMoveX] ( #20, #02 )
    COP [AnimOnce]
    COP [StageSpriteFrame] ( #1C )
    COP [AnimOnce]
    COP [PrintWideString] ( &widestring_06D3CC )
    COP [SetFlagByte] ( #8C )
    LDA #$0404
    STA $gfxCacheIdxB
...
code_06D25A {
    ...
    COP [PrintWideString] ( &widestring_06D278 )
    RTL 
}

code_06D26B {
    COP [PrintWideString] ( &widestring_06D2A4 )
    COP [SetFlagByte] ( #8A )
    RTL 
}

code_06D273 {
    COP [PrintWideString] ( &widestring_06D2FF )
    RTL 
}

widestring_06D278 `[TPL:A][TPL:0][SFX:10]Will: [N]If I don't spread [N]magic dust...[PAL:0][END]`

widestring_06D2A4 `[TPL:E][TPL:0][SFX:10]Will: [N]Kara - please return to [N]your original form.... [FIN][SFX:0]Will gently kisses the [N]picture of Kara...[PAL:0][END]`

widestring_06D2FF `[TPL:A][TPL:0][SFX:10]Will: Kara's picture. [N]She is contained [N]inside it....[PAL:0][END]`

widestring_06D339 `[TPL:A][TPL:1][SFX:1B]Kara: [N]Will....Sorry [N]for being so selfish.[FIN]`

widestring_06D364 `[TPL:A][CLR][TPL:0][SFX:10]Will: Kara!! [N]You make me so mad!! [FIN]You are not the only [N]person on this journey!  [FIN][TPL:1][SFX:1B]Kara: [N]............[PAL:0][END]`

widestring_06D3CC `[TPL:A][TPL:1][SFX:1B]Kara: [N]Whaaaaaah! [N]Sob....Sniff.... [FIN]I...Sob... I don't[N]know what I'm doing[N]myself...Sob...[FIN]When I was in the[N]castle....I could have[N]anything I wanted...[FIN]But I was a completely[N]different person[N]before this trip...[FIN][TPL:0][SFX:10]Will: Naturally! It's a [N]mistake to think you [N]can control everything!![FIN][TPL:1][SFX:1B]Kara: No! [FIN]When I'm far away, I feel [N]close to it.[FIN]When I'm close,[N]I feel far away. [N]I realize that now... [FIN]It's all right if you[N]don't understand...[FIN]I will never forget[N]what happened today.[PAL:0][END]`